...
google_search_agent = create_agent(llm, [google_search_tool], "You are a web researcher.")
google_search_node = functools.partial(agent_node, agent=google_search_agent, name="GoogleSearch")

workflow = StateGraph(AgentState)
# workflow.add_node("Researcher", research_node)
workflow.add_node("GoogleSearch", google_search_node)
